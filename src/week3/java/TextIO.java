 ...
 * static methods, and none of the methods throws exceptions that would require try...catch statements.
...
public class TextIO {
   ...
   /**
    * Puts a file-selection dialog box on the screen in which the user can select
    ...
    * <p>NOTE: Calling this method starts a graphical user interface (GUI) thread, which can continue
    ...
    * <p>NOTE: Calling this method starts a GUI thread, which can continue
    * to run even if the thread that runs the main program ends.  If you use this method
    * in a non-GUI program, it might be necessary to call System.exit(0) at the end of the main() 
    * routine to shut down the Java virtual machine completely.
    */
    ...
    * than this number of characters, then extra spaces are added in front of x to bring
   ...
   /**
    * This is equivalent to put(x), followed by an end-of-line character.
    */
   ...
   /**
    * This is equivalent to put(x,minChars), followed by an end-of-line character.
    */
   ...
   /**
    * Tests whether the next character in the current input source is an end-of-line.  Note that
    ...
    * the current line of input are retained, and will be read by the next input operation.  When using standard IO,
    * this will not produce an error.  In other cases, an IllegalArgumentException will be thrown 
    *	if an end-of-file character is encountered.
    */
   ...
   // ***************** Everything beyond this point is internal, implementation detail *******************
